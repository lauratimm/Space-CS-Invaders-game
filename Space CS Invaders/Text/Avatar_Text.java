...
/**
 * This class is the avatar (or spaceship) for our game and extend off the
 * logic Avatar_Logic class
 ...
 * */
public class Avatar_Text extends Avatar_Logic {
    private char avatar_Char = 'S';

    /**
     * This constructor creates an avatar with the instance avatar_Char.
     * 
     * @param x_coordinate The x coordinate from the logic Avatar_Logic class.
     * @param y_coordinate The y coordinate from the logic Avatar_Logic class.
     *  sets the movement so that the avatar moves 1 index at a time.
     */
    public Avatar_Text(int x_coordinate, int y_coordinate) {
        super(x_coordinate, y_coordinate);
        super.setMovement(1); // sets the movement to move index of 1
    }

    /**
     * Gets the character which is used for the Avatar_Logic
     * 
